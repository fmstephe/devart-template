...
["fish", "fish.dart", , Z, {
  ...
  Fish: {
    ...
    place$0: function() {
      var t1, t2, t3;
      this._x = $.get$Fish__rnd().nextDouble$0() * this._width;
      this._y = $.get$Fish__rnd().nextDouble$0() * this._height;
      this._z = $.get$Fish__rnd().nextDouble$0() * 2.7 + 0.3;
      t1 = $.Fish__impulse;
      t2 = $.get$Fish__rnd().nextDouble$0();
      t3 = $.Fish__impulse;
      this._vx = (t1 - t2 * (2 * t3)) * $.Fish__initImpulseSaler;
      t2 = $.get$Fish__rnd().nextDouble$0();
      t1 = $.Fish__impulse;
      this._vy = (t3 - t2 * (2 * t1)) * $.Fish__initImpulseSaler;
      this._vz = (t1 - $.get$Fish__rnd().nextDouble$0() * (2 * $.Fish__impulse)) * $.Fish__impulseScaler;
    },
    push$0: function() {
      var t1, t2, t3, t4, t5;
      t1 = this._vx;
      t2 = $.Fish__impulse;
      t3 = $.get$Fish__rnd().nextDouble$0();
      t4 = $.Fish__impulse;
      t5 = $.Fish__impulseScaler;
      if (typeof t1 !== "number")
        return t1.$add();
      this._vx = t1 + (t2 - t3 * (2 * t4)) * t5;
      t5 = this._vy;
      t3 = $.get$Fish__rnd().nextDouble$0();
      t2 = $.Fish__impulse;
      t1 = $.Fish__impulseScaler;
      if (typeof t5 !== "number")
        return t5.$add();
      this._vy = t5 + (t4 - t3 * (2 * t2)) * t1;
      t1 = this._vz;
      t3 = $.get$Fish__rnd().nextDouble$0();
      t4 = $.Fish__impulse;
      if (typeof t1 !== "number")
        return t1.$add();
      this._vz = t1 + (t2 - t3 * (2 * t4));
    },
    static: {"": "Fish_maxNear,Fish_maxFar,Fish__rnd,Fish__impulse,Fish__initImpulseSaler,Fish__impulseScaler"}
  }
}],
["", "hypnotic_go_spec.dart", , O, {
  "": "",
  main: [function() {
    var main, t1, width, height, mainCtxt, watch;
    ...
    $.fishes = O.makeFishs(width, height);
    watch = new P.Stopwatch(null, null);
    watch.start$0(watch);
    C.Window_methods.get$animationFrame(window).then$1(O.loop$closure());
  }, "call$0", "main$closure", 0, 0, 0],
  makeFishs: function(width, height) {
    var Fishs, i, t1;
    Fishs = H.setRuntimeTypeInfo([], [Z.Fish]);
    for (i = 0; i < 10000; ++i) {
      t1 = new Z.Fish(null, null, null, null, null, null, null, null);
  ...
  loop: [function(delta) {
    var t1, fish, t2, t3, t4, t5, t6, t7, t8;
    if (J.$eq($.lastStamp, 0))
      $.lastStamp = delta;
    P.print(J.$sub$n(delta, $.lastStamp));
    $.lastStamp = delta;
...
$.Expando__keyCount = 0;
$.Fish__impulse = 0.005;
$.Fish__initImpulseSaler = 60;
$.Fish__impulseScaler = 3;
...
function dart_precompiled($collectedClasses) {
  ...
  function _LinkedHashSet(_length, _strings, _nums, _rest, _first, _last, _modifications) {
    this._length = _length;
    this._strings = _strings;
    this._nums = _nums;
    this._rest = _rest;
